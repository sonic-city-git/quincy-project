...
import { SerialNumbersSection } from "../forms/SerialNumbersSection";
import { BasicEquipmentFields } from "../forms/BasicEquipmentFields";
import { Label } from "@/components/ui/label";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Input } from "@/components/ui/input";
import { EquipmentFolderSelect } from "../shared/EquipmentFolderSelect";
...
export function AddEquipmentDialog({ onAddEquipment }: AddEquipmentDialogProps) {
  ...
  const handleSerialNumberChange = (index: number, field: keyof typeof serialNumbers[0], value: string) => {

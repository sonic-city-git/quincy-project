...
export function EventCard({ event, onStatusChange, onEdit }: EventCardProps) {
  ...
  return (
    <Card key={`${event.date}-${event.name}`} className="p-4">
      <div className="grid grid-cols-[120px_1fr_50px_auto_auto_auto_auto] items-center gap-2">
        ...
        <div className="flex items-center justify-end">
          ...
          {event.type.needs_crew && <Users className="h-4 w-4 text-muted-foreground ml-2" />}
        </div>

    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-12 w-12 bg-transparent p-0 opacity-50 hover:opacity-100 rounded-full"
        ),
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-16 w-full p-0 font-normal aria-selected:opacity-100 hover:bg-zinc-800 rounded-md"
        ),
